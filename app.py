...
from flask import Flask, request, jsonify  # Flask-related imports for creating routes and handling requests
import os  # For file and path operations
from PIL import Image  # For image processing (from Pillow library)
...
app.config['MAIL_USERNAME'] = 'sumeetjha932@gmail.com'
app.config['MAIL_PASSWORD'] = 'tgwu mxgu bkvo empo'
...
app.config['NOTIF_MAIL_USERNAME'] = 'sumeetjha932@gmail.com'  # Replace with notification email
app.config['NOTIF_MAIL_PASSWORD'] = 'tgwu mxgu bkvo empo'          # Replace with notification email password
